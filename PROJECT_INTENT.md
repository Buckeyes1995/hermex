...
Hermex is a native iPhone and iPad control surface for a self-hosted Hermes AI agent stack. The app is the control plane and review surface; the macOS/server-side Hermes WebUI stack is the execution plane.
